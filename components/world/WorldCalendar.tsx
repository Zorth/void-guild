            ...
            <CardHeader className="flex flex-row items-center justify-between border-b border-border/50 px-6 py-3 bg-muted/10">
                <div className="flex items-center gap-4">
                    ...
                    <div className="text-sm font-medium px-2 py-0.5 bg-primary/10 text-primary rounded-md border border-primary/20">
                        Today: {calendar.dynamic_data.day} {todayMonthName}, {formatInGameYear(calendar.dynamic_data.year, calendar.static_data.eras, calendar.static_data.settings?.year_zero_exists, { useAbbreviation: false, labelFirst: true })}
                    </div>
                </div>
            ...
            <CardContent className="p-0">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-border/50 bg-muted/5">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground font-medium">{formatInGameYear(viewYear, calendar.static_data.eras, calendar.static_data.settings?.year_zero_exists, { useAbbreviation: false, labelFirst: true })}</p>
                    </div>
