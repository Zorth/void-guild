...
* **Live Initiative Tracker:** Event-driven initiative list with smooth Framer Motion drag-and-drop reordering, active turn tracking, round timers, and direct inline click-to-edit values for HP and tracker counters in addition to step increments.
