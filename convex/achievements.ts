...
export const ACHIEVEMENTS_REGISTRY: AchievementDefinition[] = [
  {
    ...
    category: 'normal',
    reward: 'Newbie Sprout Avatar Ring Cosmetic',
  ...
  },
  {
    ...
    category: 'normal',
    reward: 'Cyan Particle Background Tint Cosmetic',
  ...
  },
  {
    ...
    category: 'hidden',
    reward: 'Crimson Flame Particle Background Tint Cosmetic',
    chainId: 'character_level',
    tier: 2,
    maxTier: 2,
  ...
  },
  {
    ...
    category: 'normal',
    reward: 'Silver Laurel Twig Avatar Ring Cosmetic',
  ...
  },
  {
    ...
    category: 'hidden',
    reward: 'Silver Laurel Circlet Avatar Ring Cosmetic',
    chainId: 'commendations_given',
    tier: 2,
    maxTier: 3,
  ...
  },
  {
    ...
    category: 'hidden',
    reward: 'Grand Silver Laurel Wreath Avatar Ring Cosmetic',
    chainId: 'commendations_given',
    tier: 3,
    maxTier: 3,
